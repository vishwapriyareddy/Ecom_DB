...
<form action="{{ URL::to('post-product-edit-form') }}/{{ $product->id }}" method="post" enctype="multipart/form-data">
    @csrf
      ...
      <input style="margin:2Opx!important" value="{{ $product->name }}" type="text" class="form-control pt-20"  id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Product name" name="productName">
      </div>
      <div class="form-group">
        <label style="margin:2Opx!important" for="exampleInputEmail1">Product price</label>
        <input style="margin:2Opx!important" value="{{ $product->price }}" type="number" class="form-control" name="productPrice" placeholder="0.0">
        </div>
        <div class="form-group">
            <label style="margin:2Opx!important" for="exampleInputEmail1">Product discount</label>
            <input style="margin:2Opx!important"  value="{{ $product->discount }}"type="number" class="form-control" name="productDiscount" placeholder="0.0">
            </div>
      <div class="form-group">
