...
<form action="{{ URL::to('post-slider-form') }}" method="post" enctype="multipart/form-data">
    @csrf
      ...
      <input style="margin:2Opx!important" type="text" class="form-control pt-20"  id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Slider title" name="sliderTitle">
      </div>

      <div class="form-group">
        <label style="margin:2Opx!important" for="exampleInputEmail1">Slider Message</label>
        <textarea id="editor1" name="sliderMessage" style="width:300px; height:150px;"></textarea>
    </div>
